...
The following tables describes key elements generated from simulations conducted in `SPoRC`, for which can be input into an estimation framework and utilized for comparison.
...
| `Init_NAA`     | `n_regions, n_ages, n_sexes, n_sims`                         | Equilibrium initial abundance-at-age    |
