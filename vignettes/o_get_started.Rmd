...
![](figures/o_mcmc_pairs.png)
![](figures/o_mcmc_trace.png)
...
```{r}
mcmc_ts_plot <- get_mcmc_ssb_rec(mcmc, francis_model)
mcmc_ts_plot[[2]] + coord_cartesian(ylim = c(0, NA))
```
![](figures/o_mcmc_ts_plot.png)
