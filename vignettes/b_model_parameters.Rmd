...
| `ln_F_devs` | `n_regions, n_years, n_fish_fleets` | Log-scale annual fishing mortality deviations | 0 |
| `ln_F_mean_AggCatch` | `n_fish_fleets` | Log-scale mean fishing mortality for region-aggregated catch | 0.1 |
| `ln_F_devs_AggCatch` | `n_Catch_Type_years, n_fish_fleets` | Log-scale fishing mortality deviations for region-aggregated catch | 0 |
...
| `ln_fishsel_devs` | `n_regions, n_years, n_bins, n_sexes, n_fish_fleets` | Log-scale selectivity deviations (n_bins = n_ages or n_lens depending on selectivity type) | 0 |
...
| `ln_srvsel_devs` | `n_regions, n_years, n_bins, n_sexes, n_srv_fleets` | Log-scale selectivity deviations (n_bins = n_ages or n_lens depending on selectivity type) | 0 |
...
| `ln_InitDevs` | `n_regions, n_ages - 2` | Log-scale initial age structure deviations | 0 |
| `ln_RecDevs` | `n_regions, n_recdev_years` | Log-scale annual recruitment deviations | 0 |
...
| Parameter | Dimension | Description | Default |
|-----------|-----------|-------------|---------|
| `move_pars` | `n_regions, n_regions - 1, n_years, n_ages, n_sexes` | Logit-scale movement probabilities | 0 |
| `logit_move_devs` | `n_regions, n_regions - 1, n_years, n_ages, n_sexes` | Logit-scale movement deviations | 0 |
| `move_pe_pars` | `n_regions, n_ages, n_sexes` | Process error parameters for movement | 0 |
