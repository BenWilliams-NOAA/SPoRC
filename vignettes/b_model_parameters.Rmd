...
| `logit_move_devs` | `n_regions, n_regions - 1, n_years + n_proj_yrs_devs, n_ages, n_sexes` | Logit-scale movement deviations w/ projection years (can be specified as random effects) | 0 |
