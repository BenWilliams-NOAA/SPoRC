...
$$
h_{y,a,s} = \mathbf{x}_{y,a,s}^\mathsf{T} \mathbf{\beta} + \mathbf{P}_{y,a,s} \, \mathbf{\gamma}
$$

where $\mathbf{x}_{y,a,s}$ represents covariates associated with linear coefficients $\mathbf{\beta}$, and $\mathbf{P}_{y,a,s}$ are spline basis covariates weighted by spline coefficients $\mathbf{\gamma}$. 
