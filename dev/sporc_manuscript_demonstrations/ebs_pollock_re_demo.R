...
# save models
saveRDS(models, here("dev", "sporc_manuscript_demonstrations", "pollock_re_comparison", "pol_models_re.RDS"))

# Plot! -------------------------------------------------------------------
models <- readRDS(here("dev", "sporc_manuscript_demonstrations", "pollock_re_comparison", "pol_models_re.RDS"))
...
ggsave(
  here("dev", "sporc_manuscript_demonstrations", "figs", "ebs_pol_randef.png"),
  cowplot::plot_grid(
    ts_plot,
    selex_plot,
    labels = c('A', 'B'),
...
ggsave(
  here("dev", "sporc_manuscript_demonstrations", "figs", "ebs_pol_ts.png"),
  ts_plot_pres,
  height = 9, width = 8
)

ggsave(
  here("dev", "sporc_manuscript_demonstrations", "figs", "ebs_pol_selex.png"),
  selex_plot_pres,
  height = 6, width = 7
)

ggsave(
  here("dev", "sporc_manuscript_demonstrations", "figs", "ebs_pol_selex_zoom.png"),
