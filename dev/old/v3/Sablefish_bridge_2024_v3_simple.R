...
rtmb_data <- readRDS(here("dev", '2024 Base (23.5)_final model', 'RTMB.RDS'))
...
input_list <- Setup_Mod_Biologicals(input_list = input_list,
                                    ...
                                    M_offset = -0.00819813327864 # fixing Male M offset (accidently jittered from OG assessment)
)
...
input_list <- Setup_Mod_FishIdx_and_Comps(input_list = input_list,
                                          ...
                                          FishAgeComps_Type =  c("agg_Year_1-65_Fleet_1",
                                                                 "none_Year_1-65_Fleet_2"), # age comp structure for fishery fleet 1 and 2

                                          FishLenComps_Type =  c("spltRspltS_Year_1-65_Fleet_1",
                                                                 "spltRspltS_Year_1-65_Fleet_2"),  # length comp structure for fishery fleet 1 and 2
                                          FishAge_comp_agg_type = c(0,NA), # ADMB aggregation quirks, ideally get rid of this
                                          FishLen_comp_agg_type = c(1,1) # ADMB aggregation quirks, ideally get rid of this
)
...
input_list <- Setup_Mod_SrvIdx_and_Comps(input_list = input_list,
                                         ...
                                         SrvAgeComps_Type = c("agg_Year_1-65_Fleet_1",
                                                              "none_Year_1-65_Fleet_2",
                                                              "agg_Year_1-65_Fleet_3"), # survey age comp type

                                         SrvLenComps_Type = c("spltRspltS_Year_1-65_Fleet_1",
                                                              "spltRspltS_Year_1-65_Fleet_2",
                                                              "spltRspltS_Year_1-65_Fleet_3"), # survey length comp type
                                         SrvAge_comp_agg_type = c(1,NA,1), # ADMB aggregation quirks, ideally get rid of this
                                         SrvLen_comp_agg_type = c(0,0,0) # ADMB aggregation quirks, ideally get rid of this
)
...
input_list <- Setup_Mod_Fishsel_and_Q(input_list = input_list,
                                      ...
                                      fish_sel_blocks = c("Block_1_Year_1-35_Fleet_1", # block 1, fishery ll selex
                                                          ...
                                                          "Block_3_Year_57-65_Fleet_1",  # block 3 fishery ll selex
...
input_list <- Setup_Mod_Srvsel_and_Q(input_list = input_list,
                                     ...
                                     srv_sel_blocks = c("Block_1_Year_1-56_Fleet_1",  # block 1 for domestic ll survey
                                                        "Block_2_Year_57-65_Fleet_1", # block 2 for domestic ll survey
